...
# # Changes occurring in primary care Mental Health activity during the pandemic
...
highlevel["concept_desc"] = "Mental health"
detailed["concept_desc"] = "Mental health"
####################################################################
# -
